<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Student1.aspx.cs" Inherits="Stud_reg.Student1" %>
...
<body>
    ...
    <td style="text-align:center" class="style8">
        <asp:LinkButton ID="LinkButton1" runat="server" onclick="LinkButton1_Click">Student _ID:-</asp:LinkButton>
    </td>
    <td class="style21">
    ...
    <tr>
    <td class="style8" style="text-align:center" >Date of Birth:-</td>
    <td class="style21">
    ...
    <tr>
    <td style="text-align:center" class="style8">Image:-</td>
    <td class="style21">
    ...
    <td class="style21" align="right">
        ...
        <asp:Button ID="btnQual" runat="server" Text="Next" onclick="btnQual_Click" />
            ...
            <asp:View ID="View2" runat="server">
             ...
             <h3 style="text-align:center">Qualification Details</h3>
             </td>
             </tr>
             <tr>
        ...
        <td colspan="2">
           ...
           <tr>
                    <td style="text-align:center" class="style9">Student Id:-</td>
                    <td class="style22">
                        <asp:Label ID="lblStudid" runat="server"></asp:Label>
                    </td>
                </tr>
            <tr>
                    <td style="text-align:center" class="style9">Student Name:-</td>
                    <td class="style22">
            ...
            <tr>
                    <td style="text-align:center" class="style9">E-mail:-</td>
                    <td class="style22">
                        <asp:Label ID="lblmail" runat="server"></asp:Label>
                    </td>
                </tr>
            <tr>
                    <td style="text-align:center" class="style9">Date of Birth:-</td>
                    <td class="style22">
                ...
                <tr>
                    <td style="text-align:center" class="style9">Gender:-</td>
                    <td class="style22">
                        <asp:Label ID="lblGender" runat="server"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td style="text-align:center" class="style9">Class:-</td>
                    <td class="style22">
                        <asp:Label ID="lblClass" runat="server"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td style="text-align:center" class="style9">Image:-</td>
                    <td class="style22">
