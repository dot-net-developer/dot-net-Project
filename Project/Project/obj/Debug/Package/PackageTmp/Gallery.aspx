<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Gallery.aspx.cs" Inherits="Project.Gallery" %>
...
<body>
  ...
  <li class=" nav-item dropdown">
    ...
    <li class="nav-item">
    <a class="nav-link active" aria-current="page" href="Gallery.aspx">Gallery</a>
    </li>
    <li class="nav-item">
